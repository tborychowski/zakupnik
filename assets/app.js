		...
		_prototypeProperties(Form, null, {
			...
			split: {
				value: function split(first) {
					...
					$(tpl({ first: first === true, categories: this.categories, idx: idx })).appendTo(this.subforms).find("select")[0].focus();
				},
				writable: true,
				configurable: true
			},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var frameTpl = __webpack_require__(110);
	var rowTpl = __webpack_require__(111);
	var headerCellTpl = __webpack_require__(112);
	var footerCellTpl = __webpack_require__(113);
